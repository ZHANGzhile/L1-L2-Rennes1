...
AND COLUMN_NAME!="USER"  AND COLUMN_NAME!="created_at"  AND COLUMN_NAME!="password"  AND COLUMN_NAME!="mail" AND COLUMN_NAME!="id"
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <table id="datatablesSimple">
                        ...
                        <?php
                        $req = $bd->prepare("SELECT * FROM users WHERE isadmin=TRUE");
                        $req->execute();
                        $users = $req->fetchAll();
                        $req->closeCursor();
