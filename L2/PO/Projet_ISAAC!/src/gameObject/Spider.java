...
public class Spider extends GameObject{
    ...
    public Spider(int coordinateX, int coordinateY) {
        super(coordinateX, coordinateY);
    }

    public Spider(ImageIcon imageIcon, int coordinateX, int coordinateY, GamePanel gamePanel) {
...
//        }
    ...
    public void painMyself(Graphics g) {
        GameImageData.SPIDERImage.paintIcon(gamePanel,g,coordinateX,coordinateY);
        run();
