...
public class Boss extends GameObject {
    ...
    public Boss(ImageIcon imageIcon, int coordinateX, int coordinateY, GamePanel gamePanel) {
...
//        }
    ...
    public void attack(){
        ...
        if(num<=5){
            ...
            this.gamePanel.BossBulletArray.add(enemyBullet);
        }
    }
    ...
    public void painMyself(Graphics g) {
        GameImageData.BOSSImage.paintIcon(gamePanel,g,coordinateX,coordinateY);
        run();
        attack();
    }
